...
class Projects {
    projects = [{
        ...
        name: 'Tic-Tac-Toe',
        description: 'Tic Tac Toe. A game you can play in your browser.',
        ...
        name: 'Library app',
        description: 'A simple web book library',
        ...
        name: 'Calculator',
        description: ' A simple browser based calculator',
    ...
    template(project) {
        ...
        <div class="project-header">
            <h3><a href="${project.live}"><img class="project-icon" src="${project.icon}" alt="Project Icon" loading="lazy">${project.name}</a></h3>
